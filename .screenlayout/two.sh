...
xrandr \
    ...
    --output DVI-I-0 --off --output HDMI-0 --off --output DP-5 --off --output DP-4 --off \
    --output DVI-I-1 --off \
    --output DP-2 --primary --mode 1920x1080 --pos 2560x0 --rate 240 --rotate normal `#right monitor` \
